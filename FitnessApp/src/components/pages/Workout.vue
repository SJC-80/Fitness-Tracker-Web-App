...
<template>
    ...
    <section id="workout-card">
        <div class="plan-card card">
            ...
            <!-- Is selectedWK < 9? If so then 0 + selectedWk else (:) selectedWk -->
             <!-- This makes numbers that are less than 10 have a 0 in front-->
        ...
        <!--7 column grid that has up to 4 items across a particular row -->
